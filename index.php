...
<body onload="ccgen();"style="background: #212121;">
	...
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<img class="rounded-circle" src="SK.png" width="200" height="200" style="margin-top: 40px;" onclick="modalCCGEN();">
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p style="color: #FFFFFF">𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 <a href="https://t.me/SKSKH1"</a>@𝚂𝙺</p>
	</div>
